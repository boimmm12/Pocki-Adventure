...
public class CuttableTree : MonoBehaviour, Interactable
{
    public IEnumerator Interact(Transform initiator)
    {
        ...
        var pokemonWithCut = initiator.GetComponent<PockiParty>().Pockies.FirstOrDefault(p => p.Moves.Any(m => m.Base.Name == "Cut"));
        ...
        if(pokemonWithCut != null)
        {
            ...
            {
                //Yes
                yield return DialogManager.Instance.ShowDialogText($"{pokemonWithCut.Base.Name} use cut!");
